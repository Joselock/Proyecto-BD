...
public class Reporte {
    ...
    public static void mostrarVentanaReportes() throws Exception {
        // Crear un nuevo Stage
        mainStage = new Stage();
        
        // Cargar el FXML (ruta corregida)
        Parent root = FXMLLoader.load(MainWindow.class.getResource("/com/mycompany/gestorui/views/Reportes/Reporte.fxml"));
