...
public class LoginController implements Initializable {
    ...
    private final Image EYE_OPEN = new Image(
            getClass().getResourceAsStream("/com/mycompany/gestorui/images/eye-open.png"));
    private final Image EYE_CLOSED = new Image(
            getClass().getResourceAsStream("/com/mycompany/gestorui/images/eye-closed.png"));
    ...
    private void handleForgotPassword(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/mycompany/gestorui/views/Login/ForgotPassword.fxml"));
            ...
            // 🔥 CAMBIO IMPORTANTE: Usar Node en lugar de Label
            ...
            alert.setHeaderText(null);
            alert.setContentText("Error al abrir la ventana de recuperación: " + e.getMessage());
            alert.showAndWait();
        }
    }
