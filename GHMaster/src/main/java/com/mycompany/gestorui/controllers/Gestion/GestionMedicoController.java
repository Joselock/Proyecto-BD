...
public class GestionMedicoController implements Initializable {
    ...
    @FXML
    private TableColumn<Medico, Boolean> colSeleccion;
    @FXML
    private TableColumn<Medico, String> colCodigo, colNombre, colEspecialidad, colLicencia, colTelefono, colUnidad;
    @FXML
    private JFXTextField txtCodigo, txtNombre, txtEspecialidad, txtLicencia, txtTelefono, txtDatosContacto,
            txtExperiencia;
    @FXML
